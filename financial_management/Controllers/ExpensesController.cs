...
using financial_management.Data;
using financial_management.Models;

namespace financial_management.Controllers
{
    [Authorize]
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Date,Valye,CategoryId")] Expense expense)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "Id", "Description", expense.CategoryId);
            return View(expense);
        }
